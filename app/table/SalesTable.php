...
/**
 * Sales table class for handling Sales database operations
 * 
 * @property int $id Sales's unique identifier column id in database table
 * @property string $name Sales's name column name in database table
 * @property string $description Sales's description column description in database table
 */
class SalesTable extends Table
{
    ...
    /**
     * @return null|static[]
     * null or array of SalesTable Objects
     */
